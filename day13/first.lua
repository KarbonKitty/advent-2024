...
for line in fileHandle:lines() do
    ...
    elseif counter % 4 == 3 then
        ...
        local tmp = { a = tonumber(a), b = tonumber(b), c = tonumber(c), d = tonumber(d), t = tonumber(t), u = tonumber(u) }
...
for _, v in ipairs(data) do
    ...
    if x > 0 and x < 100 and math.floor(x) == math.ceil(x) and y > 0 and y < 100 and math.floor(y) == math.ceil(y) then
        total = total + (x * 3) + y
    end
end
